...
public final class Skyrama extends JavaPlugin {
    ...
    public void initConfig() {
        ...
        saveResource("locales/tr_TR.yml", false);
    ...
    public void initCommands() {
        ...
        getCommand("ada").setExecutor(new CommandManager());
    ...
    public void initEvents() {
        ...
        // GUI Event Listeners
        getServer().getPluginManager().registerEvents(new IslandMainGUI(), this);
        getServer().getPluginManager().registerEvents(new IslandVisitGUI(), this);
        getServer().getPluginManager().registerEvents(new IslandSettingsGUI(), this);
        getServer().getPluginManager().registerEvents(new IslandInfoGUI(), this);
        getServer().getPluginManager().registerEvents(new IslandInviteGUI(), this);
